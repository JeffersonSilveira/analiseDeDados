...
public class ProcessData {
	...
	private static void writeToBinaryFile() throws FileNotFoundException, IOException {
		...
		FileOutputStream fstream = new FileOutputStream(configuration.configurationFile(DIRECTORYPATHIN));
	...
	public void run() throws IOException {
		...
		report.QuantityOfSeller(DIRECTORYPATHIN);
		report.ireportCustomerQuantity(DIRECTORYPATHIN);
		report.mostExpensiveSale(DIRECTORYPATHIN);
		report.WorstSeller(DIRECTORYPATHIN);
	}
}
